...
def test_get_system_timezone_from_etc_timezone(mock_run, mock_open, system_utils, test_timezone_data):
    """Should return the timezone from /etc/timezone."""
    mock_open.return_value.__enter__.return_value.read.return_value = test_timezone_data["etc_timezone_content"]
...
def test_get_system_timezone_from_timedatectl(mock_run, mock_open, system_utils, 
                                              test_timezone_data, test_file_scenarios):
...
def test_get_system_timezone_fallback_to_utc(mock_run, mock_open, system_utils, 
                                            test_timezone_data, test_file_scenarios, test_subprocess_scenarios):
...
@patch("birdnetpi.utils.system_utils.open")
@patch("birdnetpi.utils.system_utils.subprocess.run")
def test_get_system_timezone__empty_etc_timezone_file(mock_run, mock_open, system_utils, 
                                                     test_timezone_data, test_file_scenarios):
    """Should fallback to timedatectl when /etc/timezone is empty."""
    mock_open.return_value.__enter__.return_value.read.return_value = test_file_scenarios["empty_file"]
...
@patch("birdnetpi.utils.system_utils.open")  
@patch("birdnetpi.utils.system_utils.subprocess.run")
def test_get_system_timezone__whitespace_only_etc_timezone(mock_run, mock_open, system_utils,
                                                          test_timezone_data, test_file_scenarios):
    """Should fallback to timedatectl when /etc/timezone contains only whitespace."""
    mock_open.return_value.__enter__.return_value.read.return_value = test_file_scenarios["whitespace_only"]
    mock_run.return_value.stdout = test_timezone_data["timedatectl_outputs"]["london"]
...
@patch("birdnetpi.utils.system_utils.open")
@patch("birdnetpi.utils.system_utils.subprocess.run") 
def test_get_system_timezone__permission_error_etc_timezone(mock_run, mock_open, system_utils,
                                                           test_timezone_data, test_file_scenarios):
...
@patch("birdnetpi.utils.system_utils.open")
@patch("birdnetpi.utils.system_utils.subprocess.run")
def test_get_system_timezone__malformed_timedatectl_output(mock_run, mock_open, system_utils,
                                                          test_timezone_data, test_file_scenarios):
...
@patch("birdnetpi.utils.system_utils.open")
@patch("birdnetpi.utils.system_utils.subprocess.run")
def test_get_system_timezone__timedatectl_command_not_found(mock_run, mock_open, system_utils,
                                                           test_timezone_data, test_file_scenarios, test_subprocess_scenarios):
...
@patch("birdnetpi.utils.system_utils.open")
@patch("birdnetpi.utils.system_utils.subprocess.run")
def test_get_system_timezone__timedatectl_timeout(mock_run, mock_open, system_utils,
                                                 test_timezone_data, test_file_scenarios, test_subprocess_scenarios):
...
@patch("birdnetpi.utils.system_utils.open")
@patch("birdnetpi.utils.system_utils.subprocess.run")
def test_get_system_timezone__io_error_reading_file(mock_run, mock_open, system_utils,
                                                   test_timezone_data, test_file_scenarios):
