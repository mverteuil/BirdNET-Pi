...
class TestDetectionEndpoints:
    ...
    def test_get_detections_default_params(self, client):
        ...
        assert response.status_code == 200
        client.app.container.detection_manager().get_recent_detections.assert_called_once_with(
            limit=100
        )
    ...
    def test_get_detection_spectrogram_success(self, client):
        ...
        client.app.container.plotting_manager().generate_spectrogram.return_value = (
            mock_spectrogram_buffer
        )
    ...
    def test_get_detection_spectrogram_error_handling(self, client):
        ...
        client.app.container.plotting_manager().generate_spectrogram.side_effect = Exception(
            "Plotting error"
        )
