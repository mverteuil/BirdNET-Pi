...
from birdnetpi.cli.pulseaudio_tool import cli
...
class TestPulseAudioTool:
    ...
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.setup_streaming")
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.get_container_ip")
    ...
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.test_connection")
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.get_container_ip")
    ...
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.get_status")
    ...
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.get_audio_devices")
    ...
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.cleanup_config")
    ...
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.is_macos")
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.is_pulseaudio_installed")
    @patch("birdnetpi.cli.pulseaudio_tool.PulseAudioSetup.install_pulseaudio")
