...
class TestProfilingMiddleware:
    ...
    def test_html_profiling_enabled(self, mock_profiler_class, app_with_html_profiling):
        ...
        mock_profiler = MagicMock(spec=Profiler, is_running=False)
...
class TestMiddlewareDispatch:
    ...
    async def test_dispatch_with_html_profiling(self):
        ...
        mock_request.url.query = "profile=1"
    ...
    async def test_dispatch_with_profiling_and_other_params(self):
        ...
        mock_request.url.query = "period=day&profile=1&filter=active"
        mock_request.method = "GET"
    ...
    async def test_dispatch_without_profiling_with_other_params(self):
        ...
        mock_request.url.query = "period=week&comparison=month"
        mock_response = Response(content="Normal response")
