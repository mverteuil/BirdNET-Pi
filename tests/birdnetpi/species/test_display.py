...
def detection_no_common():
    ...
    detection = MagicMock(
        ...
        translated_name="Moineau domestique",
    )
    return detection
...
class TestFormatSpeciesDisplay:
    ...
    def test_fallback_to_scientific_when_no_common(self, display_service):
        ...
        detection = MagicMock(
            spec=Detection,
            scientific_name="Fallback species",
            common_name=None,
            ioc_english_name=None,
            translated_name=None,
        )
...
class TestEdgeCases:
    ...
    def test_all_names_none_except_scientific(self, display_service):
        ...
        detection = MagicMock(
            spec=Detection,
            scientific_name="Only scientific",
            common_name=None,
            ioc_english_name=None,
            translated_name=None,
        )
    ...
    def test_prefer_translation_all_none_fallback(self, display_service):
        ...
        detection = MagicMock(
            spec=Detection,
            scientific_name="Scientia fallbackus",
            common_name="Fallback Bird",
            ioc_english_name=None,
            translated_name=None,
        )
