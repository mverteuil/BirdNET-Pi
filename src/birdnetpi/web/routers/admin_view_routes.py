...
async def get_settings(
    ...
    return templates.TemplateResponse("settings.html", {"request": request, "config": app_config})
...
async def test_detection_form(
    ...
    return templates.TemplateResponse("test_detection_modal.html", {"request": request})
